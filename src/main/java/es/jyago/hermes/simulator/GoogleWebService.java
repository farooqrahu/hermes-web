...
@WebListener
public class GoogleWebService implements ServletContextListener {

    private static final Logger LOG = Logger.getLogger(GoogleWebService.class.getName());
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        executor.shutdown();
        LOG.log(Level.INFO, "contextInitialized() - Finalización");
    }
